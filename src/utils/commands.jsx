...
export const commands = {
    ...
    execute: () => (
      <div className="flex flex-col gap-2 animate-in fade-in duration-300">
        ...
        <div className="grid grid-cols-[120px_1fr] gap-2 text-sm md:text-base">
          ...
          <span className="text-cyan-400 font-bold">honors</span>
          <span className="text-gray-300">Awards & Achievements</span>
      ...
      <div className="flex flex-col md:flex-row gap-6 animate-in slide-in-from-left-4 duration-500 items-start">
        <div className="flex-1 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3 leading-relaxed text-gray-300">
            ...
            <p>
              Computer Science undergraduate with strong foundations in data structures, databases, and development. 
              Experienced in building scalable, data driven applications and real-time systems using Python, SQL, and modern web technologies.
            </p>
            <p className="border-l-2 border-purple-500 pl-3 italic text-gray-400">
              "Skilled in translating problem statements into technical solutions, collaborating in team environments, and applying structured problem solving approaches."
            </p>
            <div className="flex gap-2 mt-2">
               <span className="bg-gray-800 px-2 py-1 rounded text-xs text-cyan-300">#FullStack</span>
               <span className="bg-gray-800 px-2 py-1 rounded text-xs text-purple-300">#Cybersecurity</span>
               <span className="bg-gray-800 px-2 py-1 rounded text-xs text-green-300">#RealTimeSystems</span>
            </div>
          </div>
        </div>
        ...
        <div className="w-32 h-32 md:w-40 md:h-40 shrink-0 border-2 border-dashed border-gray-700 p-1 rounded-lg hover:border-cyan-500 transition-colors duration-300 relative group">
           <img 
              src="https://github.com/divyanshuchander.png" 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <div className="grid grid-cols-2 gap-2">
                    {['C / C++', 'Python', 'JavaScript', 'TypeScript', 'Java', 'SQL'].map(s => (
            ...
            <div>
                 <div className="text-xs text-gray-500 mb-1 border-b border-gray-800 pb-1">BACKEND & TOOLS</div>
                 <div className="grid grid-cols-2 gap-2">
                    {['Node.js', 'Express', 'Flask', 'React', 'Git / GitHub', 'Docker', 'Postman', 'Burp Suite'].map(s => (
                        <div key={s} className="flex items-center gap-2">
            ...
            <div className="col-span-1 md:col-span-2">
                 ...
                 <div className="flex flex-wrap gap-2">
                     {['Data Structures', 'Algorithms', 'Object-Oriented Design', 'DBMS', 'OS', 'Computer Networks'].map(s => (
      ...
      <div className="flex flex-col gap-6 animate-in slide-in-from-bottom-4 duration-500">
        ...
        <div className="group border border-gray-800 p-4 rounded bg-gray-900/40 hover:bg-gray-900/60 hover:border-cyan-500/50 transition-all duration-300 backdrop-blur-sm">
          <div className="flex justify-between items-start mb-2">
            <h3 className="text-cyan-400 font-bold text-lg group-hover:text-cyan-300">CollabCode Studio</h3>
            <span className="text-xs border border-blue-500/50 text-blue-400 px-2 py-0.5 rounded bg-blue-500/10">2025</span>
          </div>
          <div className="mb-2 text-xs text-gray-500 font-mono">STACK: React, TypeScript, Node.js, Express, Socket.IO</div>
          <p className="mb-3 text-gray-300 leading-snug">
            Real-Time Collaborative Code Editor. Multi-user execution, live synchronization of files/chat, sandboxed multi-language execution (40+ languages).
          </p>
          <a href="https://github.com/divyanshuchander/CollabCode-MajorProject" target="_blank" className="inline-flex items-center text-sm text-purple-400 hover:text-purple-300 transition-colors">
            &gt; View Source <span className="ml-1 opacity-0 group-hover:opacity-100 transition-opacity">→</span>
          </a>
        </div>
        ...
        <div className="group border border-gray-800 p-4 rounded bg-gray-900/40 hover:bg-gray-900/60 hover:border-cyan-500/50 transition-all duration-300 backdrop-blur-sm">
          ...
          <div className="mb-2 text-xs text-gray-500 font-mono">STACK: Python, Flask, JavaScript, FFmpeg, YouTube API</div>
          <p className="mb-3 text-gray-300 leading-snug">
            AI Media Summarization Tool. Generates concise summaries from YouTube videos and local media. Optimized speech-to-text pipelines.
          </p>
          <a href="https://github.com/divyanshuchander/AutoNotes" target="_blank" className="inline-flex items-center text-sm text-purple-400 hover:text-purple-300 transition-colors">
             &gt; View Source <span className="ml-1 opacity-0 group-hover:opacity-100 transition-opacity">→</span>
          </a>
        </div>
        ...
        <div className="group border border-gray-800 p-4 rounded bg-gray-900/40 hover:bg-gray-900/60 hover:border-cyan-500/50 transition-all duration-300 backdrop-blur-sm">
          <div className="flex justify-between items-start mb-2">
            <h3 className="text-cyan-400 font-bold text-lg group-hover:text-cyan-300">Student DB System</h3>
            <span className="text-xs border border-gray-500/50 text-gray-400 px-2 py-0.5 rounded bg-gray-500/10">DB</span>
          </div>
          <div className="mb-2 text-xs text-gray-500 font-mono">STACK: Python, MySQL, SQL</div>
          <p className="mb-3 text-gray-300 leading-snug">
            Student Database Management System. Python/MySQL application for managing records with robust schemas and CRUD operations.
          </p>
          <a href="https://github.com/divyanshuchander/Student-Database-Management-Project" target="_blank" className="inline-flex items-center text-sm text-purple-400 hover:text-purple-300 transition-colors">
            &gt; View Source <span className="ml-1 opacity-0 group-hover:opacity-100 transition-opacity">→</span>
          </a>
        </div>
  ...
  honors: {
    ...
    execute: () => (
      <div className="flex flex-col gap-4 animate-in fade-in duration-500">
        <div className="text-terminal-accent glow-text">Achievements Unlocked:</div>
        ...
        <div className="flex flex-col gap-3">
             <div className="flex flex-col border-l-2 border-yellow-500 pl-3">
                 <div className="flex justify-between text-yellow-200 font-bold">
                     <span>Smart India Hackathon 2023</span>
                     <span className="text-sm opacity-70">2023</span>
                 </div>
                 <div className="text-sm text-gray-400">Top 5 Teams in Selection Round (National Level)</div>
             </div>

             <div className="flex flex-col border-l-2 border-gray-500 pl-3">
                 <div className="flex justify-between text-gray-200 font-bold">
                     <span>Hache 3.0 (Cybersecurity)</span>
                     <span className="text-sm opacity-70">2023</span>
                 </div>
                 <div className="text-sm text-gray-400">3rd Position -- 24-hour Capture The Flag (University Level)</div>
             </div>

             <div className="flex flex-col border-l-2 border-cyan-500 pl-3">
                 <div className="flex justify-between text-cyan-200 font-bold">
                     <span>Qriosity (Technical)</span>
                     <span className="text-sm opacity-70">2023-24</span>
                 </div>
                 <div className="text-sm text-gray-400">1st Position (2024), 2nd Position (2023) among 50+ participants</div>
             </div>
        </div>
      </div>
    ),
